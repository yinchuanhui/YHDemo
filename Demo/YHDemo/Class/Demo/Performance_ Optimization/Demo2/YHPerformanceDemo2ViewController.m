//
//  YHPerformanceDemo2ViewController.m
//  YHDemo
//
...
#import "YHPerformanceDemo2ViewController.h"

@interface YHPerformanceDemo2ViewController ()

@property (nonatomic, retain)UIScrollView *scrollView;

@end

@implementation YHPerformanceDemo2ViewController
...
- (void)viewDidLoad {
    ...
    for (int i = 1; i <= 14; i++) {
        [self addImageViewWithName:[NSString stringWithFormat:@"optimizing_demo_image_%d", i] containerView:self.scrollView];
    }
}
